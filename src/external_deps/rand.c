 ...
 *	when needed.
 *	- Use a non-leaking generator in contexts where attackers that have
 *access to side channels are a plausible threat (a process in an OS sharing
 *memory and caches with other possibly malicious processes, a microcontroller
